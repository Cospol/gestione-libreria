	...
	<main role="main" class="container">
		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form method="post" action="ExecuteInsertCdServlet" novalidate="novalidate">
						...
						<div class="form-row">	
							<div class="form-group col-md-6">
								...
								<input type="number" class="form-control" name="pagine" id="pagine" placeholder="Inserire le pagine" required>
							</div>
